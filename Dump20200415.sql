...
INSERT INTO `bloodstorage` VALUES (1,'2020-07-16','A','positive',1),(2,'2020-06-16','O','positive',1),(3,'2020-05-16','B','positive',1),(4,'2020-08-16','O','negative',0),(5,'2020-09-16','A','positive',0),(6,'2038-01-12','B','negative',1);
...
CREATE TABLE `clinic` (
  ...
  CONSTRAINT `clinic_ibfk_1` FOREIGN KEY (`ManagerID`) REFERENCES `employee` (`EmployeeID`)
...
INSERT INTO `clinic` VALUES (403737373,1,'Calgary',5),(403737313,2,'Edmonton',5),(403731111,3,'Toronto',5),(403213273,4,'Vancouver',5),(915232232,5,'Banff',5);
...
INSERT INTO `donor` VALUES (1,'Peter Parker','A','positive',50),(2,'Tony Stark','A','negative',50),(3,'Barack Obama','O','positive',50),(4,'Kanye West','A','positive',50),(5,'Kevin Durant','B','positive',50),(6,'Dan','A','positive',380),(7,'Not Daniel','A','positive',55),(8,'Test User','B','negative',300);
...
INSERT INTO `employee` VALUES (1,'1234 Rainbow Rd','123456789','Employee One','Employee',1),(2,'1234 Rainbow Rd','123456789','Employee Two','Employee',1),(3,'1234 Rainbow Rd','123456789','Employee Three','Employee',1),(4,'1234 Rainbow Rd','123456789','Employee Four','Employee',1),(5,'1234 Rainbow Rd','123456789','Big Boss','Supervisor',1);
/*!40000 ALTER TABLE `employee` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `employeeevents`
--
...
CREATE TABLE `employeeevents` (
  ...
  CONSTRAINT `employeeevents_ibfk_1` FOREIGN KEY (`eventID`) REFERENCES `events` (`EventDate`),
  CONSTRAINT `employeeevents_ibfk_2` FOREIGN KEY (`employeeID`) REFERENCES `employee` (`EmployeeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `employeeevents`
--

LOCK TABLES `employeeevents` WRITE;
/*!40000 ALTER TABLE `employeeevents` DISABLE KEYS */;
INSERT INTO `employeeevents` VALUES ('2020-05-09',1),('2020-05-09',2),('2020-05-09',3),('2020-05-09',4),('2020-05-09',5);
/*!40000 ALTER TABLE `employeeevents` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `events` (
  ...
  KEY `EmployeeID` (`EmployeeID`),
  CONSTRAINT `events_ibfk_1` FOREIGN KEY (`ClinicID`) REFERENCES `clinic` (`ClinicID`),
  CONSTRAINT `events_ibfk_2` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`EmployeeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `events` VALUES ('2020-04-09','Calgary',1,1),('2020-05-09','Calgary',2,2),('2020-06-09','Calgary',3,3),('2020-07-09','Calgary',4,4),('2020-08-09','Calgary',5,5);
...
INSERT INTO `hospital` VALUES (1,'Calgary','Foothills Hospital'),(2,'Calgary','Childrens Hospital'),(3,'Toronto','St Johns Hospital'),(4,'Edmonton','Edmonton Hospital'),(5,'Calgary','Nenshi Hospital');
...
INSERT INTO `prize` VALUES (1,3,100),(2,50,100),(3,1,1000),(4,100,100),(5,100,50),(6,500,5),(7,500,15);
/*!40000 ALTER TABLE `prize` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `prizetransaction`
--

DROP TABLE IF EXISTS `prizetransaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prizetransaction` (
  ...
  KEY `donorID` (`donorID`),
  KEY `PID` (`PID`),
  CONSTRAINT `prizetransaction_ibfk_1` FOREIGN KEY (`donorID`) REFERENCES `donor` (`DonorID`),
  CONSTRAINT `prizetransaction_ibfk_2` FOREIGN KEY (`PID`) REFERENCES `prize` (`PID`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `prizetransaction`
--

LOCK TABLES `prizetransaction` WRITE;
/*!40000 ALTER TABLE `prizetransaction` DISABLE KEYS */;
INSERT INTO `prizetransaction` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,5),(7,6,5);
/*!40000 ALTER TABLE `prizetransaction` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `request` VALUES (1,1,'2020-06-01',1,100,'A','positive',0,1),(2,2,'2020-07-01',2,100,'O','negative',0,2),(3,3,'2020-08-01',3,100,'B','positive',0,3),(4,4,'2020-09-01',4,100,'AB','positive',0,4),(5,5,'2020-10-11',5,100,'O','positive',0,2),(6,1,NULL,3,500,'B','negative',0,NULL),(7,1,NULL,3,500,'B','negative',0,NULL),(8,1,NULL,3,500,'B','negative',0,NULL),(9,1,NULL,3,1500,'B','negative',0,NULL);
...
CREATE TABLE `volunteer` (
  ...
  KEY `ClinicID` (`ClinicID`),
  CONSTRAINT `volunteer_ibfk_1` FOREIGN KEY (`ClinicID`) REFERENCES `clinic` (`ClinicID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `volunteer` VALUES (1,'Daniel Nwaroh','Volunteer','123 Some Rd NW','123456789',1),(2,'Lebron James','Supervisor','123 Some Rd NW','123456789',1),(3,'Donald Trump','Supervisor','123 White House Ave','98765431',1),(4,'Clark Kent','Volunteer','Kyrpton Street','11111111',1),(5,'Bruce Wayne','Volunteer','50 Gotham Road','99999999',1);
...
--
-- Dumping routines for database 'bloodstorageapi'
--
/*!50003 DROP PROCEDURE IF EXISTS `addBloodStorage` */;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `addDonorPoints` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AddEmployeeEvent` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AddPrize` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `addPrizeTransaction` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
BEGIN
    ...
    values (paramClinicID, paramDateCompleted, paramHospitalID, paramAmount, paramBloodType, paramRHFactor, 0, null);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AddVolunteerEvent` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getAllEmployeesOfClinic` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getBloodStorage` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getDonorByBloodType` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getDonorByRHF` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getDonorInfo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetEmployeeEvent` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getHospitalInfo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getRequestByBloodType` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetVolunteersEvent` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateBloodStorage` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateDonorName` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateDonorQty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `updateHospitalName` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdatePrize` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2020-04-15 16:22:53
